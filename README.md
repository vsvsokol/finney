...
| Экраны по дизайн-системе | все экраны сценария: знакомство, создание питомца, главный, план, магазин, копилка, мини-игры, итоги, прогресс и история, справочник, раздел взрослого |
| Обязательные требования ТЗ | 76 из 99 закрыто, 15 в работе — [docs/requirements-matrix.md](docs/requirements-matrix.md) |
| Сценарий Приложения А | все 12 шагов проходятся (эмулятор API 37, 26.09) |

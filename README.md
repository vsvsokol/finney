...
| Экраны по дизайн-системе | главный, план бюджета, создание питомца, итоги периода |
| Обязательные требования ТЗ | 34 из 81 закрыто, 20 в работе — [docs/requirements-matrix.md](docs/requirements-matrix.md) |

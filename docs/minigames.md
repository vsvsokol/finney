...
### Картинка предмета: `art` или `emoji`
...
- `"emoji": "⚽"` — временный значок, пока рисунка нет;
- ничего — тогда в кружке будет первая буква названия.

Если указаны оба, берётся картинка. Опечатка в `art` игру не ломает — покажется эмодзи или буква.
**В текстах эмодзи нет**: ни во вступлениях, ни в объяснениях, ни в названиях. `ContentTest`
падает, если эмодзи попал в любую строку JSON, кроме поля `emoji`.
...
**`goal_race` — Дорога к цели.** `goal` — `{ "label", "price", "art" или "emoji" }`. `days` — сколько
...
- **Эмодзи вместо рисунков** у 31 предметов — временно, пока нет рисунков в стиле кита.
  Нарисовать `design/exports/items/item_*.png`, прописать `art` в JSON (эмодзи тогда можно
  удалить) и запустить `pack_items.py`. Список ниже собран из `tasks.json`.
...
### Какие значки нужно нарисовать

| Эмодзи | Предметы | Игры |
|---|---|---|
| ⚽ | Мячик | Дождливый день, Конвейер |
| 🧥 | Вторая куртка, Тёплая куртка зимой | Конвейер |
| 🪥 | Зубная паста, Зубная щётка | Конвейер |
| 🌟 | Наклейки | Дождливый день, Дорога к цели, Конвейер |
| 📓 | Тетради, Тетради к школе | Дождливый день, Конвейер |
| 🧸 | Игрушка из автомата | Дорога к цели, Конвейер |
| 💧 | Бутылка воды | Конвейер |
| 🥤 | Газировка | Конвейер |
| 🚌 | Билет на автобус до школы, Проезд | Дождливый день, Конвейер |
| 🔑 | Брелок на рюкзак | Конвейер |
| 💊 | Лекарство, когда болеешь | Конвейер |
| 🧢 | Шапка зимой, Шапка с ушками, когда шапка уже есть | Конвейер |
| 🍞 | Хлеб | Конвейер |
| 👟 | Кроссовки как у друга, когда свои целые, Кроссовки, когда старые стали малы, Порвались кроссовки! | Дождливый день, Конвейер |
| ☂️ | Второй зонт, покрасивее, Зонт, когда старый сломался, Сломался зонт! | Дождливый день, Конвейер |
| 🍲 | Обед в школе | Конвейер |
| 🎂 | Торт без праздника | Конвейер |
| 🎲 | Ещё одна настольная игра | Конвейер |
| 📺 | Подписка на мультики | Конвейер |
| ✏️ | Карандаши, когда старые кончились | Конвейер |
| 📱 | Наклейки на телефон | Конвейер |
| 🛴 | Самокат | Дорога к цели |
| 🍦 | Мороженое, Мороженое с другом | Дождливый день, Дорога к цели |
| 🎬 | Кино | Дождливый день, Дорога к цели |
| 🧱 | Конструктор | Дорога к цели |
| 🛼 | Ролики | Дорога к цели |
| 🍭 | Сладкая вата | Дорога к цели |
| 🎮 | Новая игра | Дождливый день, Дорога к цели |
| 🎒 | Порвался рюкзак! | Дождливый день |
| 🍋 | Большой лимон, Лимон | Лимонадная лавка |
| 📖 | Книжка | Касса Финни |

...
// [@mitzzi4], [@vsvsokol] и [@zYafALL] рисовались по шаблону [@lemonke68], поэтому холст у них тот же.
// Точки вращения не подбирались на глаз: плечи и бёдра — это верхний внутренний
// угол альфы соответствующего слоя, точка опоры — низ силуэта. По [@Lix2w78] и [@lemonke68]
